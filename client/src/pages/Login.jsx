...
const Login = () => {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen relative p-6">
            <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-blue-600/10 to-indigo-900/20 pointer-events-none"></div>
            ...
            <div className="w-full max-w-md bg-slate-900/40 backdrop-blur-2xl p-10 rounded-[2.5rem] border border-white/10 shadow-2xl relative overflow-hidden">
                ...
                <p className="text-slate-400 text-center mb-10 text-sm font-medium">Secure access to your BankUs account</p>
